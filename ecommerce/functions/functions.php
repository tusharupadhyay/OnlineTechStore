	...
	while($row_pro=mysqli_fetch_array($run_pro)){
		...
		echo "
				<div id='single_product'>
					...
					<img src='admin_area/product_images/$pro_image' width='400' height='300' class='img-rounded' />
					
					<p><b> $ $pro_price </b></p>
					
					<p>$pro_desc </p>
					
					<a href='index.php' style='float:left;'><button class='btn btn-primary'style='float:left'>Go Back</button></a>
					
					<a href='details.php?add_cart=$pro_id'><button class='btn btn-primary' style='float:right'>Add to cart</button></a>
